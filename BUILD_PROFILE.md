...
Paste this prompt into any AI chat tool you already use. It will interview you section by section and draft a complete `teacher.md` at the end.
...
- If you need to stop, say `resume` when you come back.
